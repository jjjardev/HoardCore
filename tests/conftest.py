...
class TempConfig:
    ...
    def get(self, path: str, default=None):
        ...
        value = {
            ...
            "embeddings": {"enabled": True, "mode": "sparse", "dense_model": "sentence-transformers/all-MiniLM-L6-v2", "dim": 64, "hybrid_search": True, "top_k": 40, "conf_high_abs": 0.025, "conf_low_abs": 0.013},
